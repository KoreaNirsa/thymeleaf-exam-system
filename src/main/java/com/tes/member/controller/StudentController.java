...
public class StudentController {
	 ...
	 * 학생 목록 페이지를 반환합니다.
	 * <p>
	 * 이 컨트롤러는 학생들의 기수, 이름, 연락처, 평균 점수 및 등수 정보를 포함한 페이징된 학생 리스트를 조회하여 뷰에 전달합니다.
	 * </p>
	 *
	 * <ul>
	 * <li>페이징 처리를 위해 {@link Pageable}을 사용합니다.</li>
	 * <li>서비스로부터 {@link Page}&lt;StudentListResDTO&gt;를 받아 리스트 및 페이지 정보를 모델에
	 * 담습니다.</li>
	 ...
	 * 새로운 학생을 등록합니다.
	 * <p>
	 * 전달받은 {@link StudentAddReqDTO} 객체를 기반으로 학생 정보를 저장하며, 저장 후에는 학생 목록 페이지로
	 * 리다이렉트됩니다.
	 * </p>
	 *
	 * <ul>
	 ...
	 * <li>학생 등록 처리는
	 * {@link com.example.service.StudentService#addStudent(StudentAddReqDTO)}에
	 * 위임됩니다.</li>
	 ...
	 * {@link com.tes.member.response.StudentDetailInfoResDTO}를 조회한 뒤, 해당 정보를 뷰 모델에
	 * 포함시켜 "pages/studentDetail" 템플릿을 렌더링합니다.
	 * </p>
	 *
	 ...
	 *
	 * @see com.tes.member.service.StudentService#getStudentDetail(long, double,
	 *      int)
	 * @see com.tes.member.response.StudentDetailInfoResDTO
	 * @since 1.0
	 */
	@GetMapping("/{memberId}")
	public String detail(@PathVariable("memberId") long memberId, @RequestParam("avg") double avg,
			@RequestParam("rank") int rank, Model model) {
