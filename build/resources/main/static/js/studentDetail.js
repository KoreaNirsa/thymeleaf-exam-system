...
function openFeedbackModal(avgScore, rank, memberId, subjectName, feedback, subjectId, studentExamSubmissionId) {
	const feedbackAvgScore = document.createElement('input');
	feedbackAvgScore.type = 'hidden';
	feedbackAvgScore.id = 'avgScore';
	feedbackAvgScore.name = 'avgScore';
	feedbackAvgScore.value = avgScore;
	feedbackForm.appendChild(feedbackAvgScore);

	const feedbackRank = document.createElement('input');
	feedbackRank.type = 'hidden';
	feedbackRank.id = 'rank';
	feedbackRank.name = 'rank';
	feedbackRank.value = rank;
	feedbackForm.appendChild(feedbackRank);

	const feedbackMemberId = document.createElement('input');
	feedbackMemberId.type = 'hidden';
	feedbackMemberId.id = 'memberId';
	feedbackMemberId.name = 'memberId';
	feedbackMemberId.value = memberId;
	feedbackForm.appendChild(feedbackMemberId);
